...
<div class="flex space-x-2">
	<div>
		<button
			class="m-4 inline-block px-4 py-2 rounded bg-primary text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]"
			type="button"
		...
		>
			<div class="flex items-center justify-between p-4">
				<h5 class="mb-0 font-semibold leading-normal" id="offcanvasExampleLabel">Hello! 👋</h5>
				<button
					type="button"
			...
			<div class="flex-grow overflow-y-auto p-4">
				<div class="flex justify-between flex-col h-full">
					<div>
						<button on:click={handleLogout}><i class="fas fa-sign-out-alt" /> Logout</button>
					</div>
					<p class="text-sm">
						<DevCredit />
					</p>
